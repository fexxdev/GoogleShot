const MESSAGES = {
  en: {
    ...
    sessionCookies: 'Session: $1 cookies from $2.',
    sessionSaved: 'Session: saved cookies ($1)',
  ...
  it: {
    ...
    sessionCookies: 'Sessione: $1 cookie da $2.',
    sessionSaved: 'Sessione: cookie salvati ($1)',
